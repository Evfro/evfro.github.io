...
BLOG_AUTHOR = "Evgeny Frolov"  # (translatable)
BLOG_TITLE = "EigenTheories"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.eigentheories.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://evfro.github.io/"
BLOG_EMAIL = "evgeny.frolov@outlook.com"
BLOG_DESCRIPTION = "This is a personal site for sharing my thoughts and experience on the machine learning topics I care the most."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        (
            (
                ("https://github.com/Evfro/polara/", "Polara"),
                ("https://github.com/Evfro/ipypb/", "ipypb"),
            ),
            "Software"
        )
    ),
...
# is in the manual.
COMMENT_SYSTEM_ID = "https-evfro-github-io"
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-147991388-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-147991388-1');
</script>
"""
